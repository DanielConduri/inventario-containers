...
@Component({
  selector: 'app-mostrar-administracion',
  templateUrl: './mostrar-administracion.component.html',
  styleUrls: ['./mostrar-administracion.component.css']
})
export class MostrarAdministracionComponent implements OnInit {
