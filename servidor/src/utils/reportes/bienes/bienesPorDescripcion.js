...
function generarPDFBienesPorDescripcion(contenido, titulo) {
  ...
  return new Promise((resolve, reject) => {
    const doc = new PdfkitConstruct({
      size: "A4",
      margins: { top: 10, left: 10, right: 25, bottom: 10 },
      bufferPages: true,
      //autoFirstPage: true,
    });
    var fecha = new Date();
    ...
    doc.addTable(
      [
        ...
        //{ key: "str_codigo_bien_anterior", label: "CÓDIGO ANTERIOR", align: "center", width:70},
        { key: "str_catalogo_bien_id_bien", label: "IDENTIFICADOR", align: "center", width:70},
        { key: "str_bien_nombre", label: "BIEN", align: "center", width:70},
        { key: "str_bien_modelo", label: "MODELO", align: "center", width:40},
        { key: "str_bien_serie", label: "SERIE", align: "center", width:40},
        //{key:"str_bien_descripcion", label:"DESCRIPCION", align:"center", width:80},
      ],
      contenido,
      {
...
export default generarPDFBienesPorDescripcion;