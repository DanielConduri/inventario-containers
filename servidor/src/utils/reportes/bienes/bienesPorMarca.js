...
function generarPDFBienesPorMarca(contenido, titulo, marca) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.addTable(
      [
        ...
        { key: "str_bien_modelo", label: "MODELO", align: "center", width:70},
        { key: "str_bien_color", label: "COLOR", align: "center", width:50, },
        { key: "dt_bien_fecha_compra", label: "FECHA DE COMPRA", align: "center", width:60,},
        {key:"str_bien_nombre", label:"NOMBRE", align:"center", width:80,},
      ],
      contenido,
      {
...
export default generarPDFBienesPorMarca;