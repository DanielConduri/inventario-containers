...
//generarPDFBienesConGarantiaPorFechas
...
function generarPDFBienesConGarantiaPorFechas(contenido, titulo,fechaInicio,fechaFinal) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.setDocumentHeader({ height: 150 }, () => {
      ...
      doc.text(`Fecha Inicio: ${ fechaInicio } - Fecha Fin: ${ fechaFinal }`, {
        align: "center",
      })
...
export default generarPDFBienesConGarantiaPorFechas;
